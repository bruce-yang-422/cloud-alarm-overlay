...
首頁天氣點擊後開啟目前行政區的氣象署鄉鎮預報頁，數值來源仍為 Open-Meteo。
CWA 七碼 TID 與本清單的內政部八碼行政區碼不同：六都使用縣市前兩碼＋行政區碼第 5–7 碼＋00；其他縣市使用前七碼。
已於 2026-09-24 對照 https://www.cwa.gov.tw/Data/js/info/Info_Town.js 核對 368 個產生代碼皆存在於官方清單。
例如五股區 65000150 對應 6501500。沒有可對應的已儲存地點時，開啟不指定 TID 的鄉鎮預報選擇頁。
